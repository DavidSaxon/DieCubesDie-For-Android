...
public class TapPoint extends GUIDrawable {
    ...
    public TapPoint(Vector2d pos, Bounding bounding) {
    ...
    public TapPoint(Shape point, Vector2d pos, Bounding bounding) {
